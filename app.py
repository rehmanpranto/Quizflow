...
# --- User Data Store (Simulating a User Database - In-Memory) ---
USER_ACCOUNTS = {} # Stores email: hashed_password
SUBMITTED_QUIZZES = set() # Stores emails of users who have submitted the quiz

# --- Quiz Content (Full list of 20 questions as provided) ---
quiz_content = {
    "title": "Market Research and Marketing Mix Quiz",
    "timeLimit": 1200,
    "questions": [
        {"id": 1, "question": "What is the primary purpose of market research?", "options": ["To increase company profits immediately", "To gather, analyze, and interpret data about markets to inform business decisions", "To create advertising campaigns", "To hire new employees"], "answer": 1},
        {"id": 2, "question": "Which of the following is an example of primary research?", "options": ["Reading industry reports", "Analyzing government statistics", "Conducting surveys with customers", "Reviewing competitor websites"], "answer": 2},
        {"id": 3, "question": "What type of research involves analyzing existing data from reports and online sources?", "options": ["Primary research", "Secondary research", "Qualitative research", "Quantitative research"], "answer": 1},
        {"id": 4, "question": "Which research method focuses on numerical data and closed-ended questions?", "options": ["Qualitative research", "Observational research", "Quantitative research", "Focus group research"], "answer": 2},
        {"id": 5, "question": "What are the 4Ps of marketing collectively known as?", "options": ["Marketing strategy", "Marketing mix", "Marketing plan", "Marketing framework"], "answer": 1},
        {"id": 6, "question": "Which of the following is NOT one of the 4Ps of marketing?", "options": ["Product", "Price", "People", "Place"], "answer": 2},
        {"id": 7, "question": "The \"Product\" element of the marketing mix includes all of the following EXCEPT:", "options": ["Design and features", "Quality and branding", "Distribution channels", "Packaging and warranties"], "answer": 2},
        {"id": 8, "question": "What factors should be considered when determining the \"Price\" element?", "options": ["Production costs only", "Competitor pricing only", "Production costs, competitor pricing, perceived value, and profit margins", "Customer demographics only"], "answer": 2},
        {"id": 9, "question": "The \"Place\" element of the marketing mix primarily focuses on:", "options": ["Where advertisements are placed", "How and where customers can access the product", "The physical location of the company", "The price point of the product"], "answer": 1},
        {"id": 10, "question": "Which of the following best describes the \"Promotion\" element?", "options": ["Price discounts and sales", "Product development activities", "Communication strategies to inform and persuade customers", "Distribution logistics"], "answer": 2},
        {"id": 11, "question": "What is a key benefit of conducting market research?", "options": ["Guaranteeing product success", "Eliminating all business risks", "Understanding consumer needs and behaviors", "Reducing production costs"], "answer": 2},
        ...
        {"id": 19, "question": "Which statement about the marketing mix is true?", "options": ["Each element works independently", "Price is the most important element", "All four elements are interconnected", "Promotion should be the primary focus"], "answer": 2},
        {"id": 20, "question": "What is the ultimate goal of the promotion element?", "options": ["To reduce production costs", "To build awareness, generate interest, and drive sales", "To improve product quality", "To expand distribution channels"], "answer": 1}
    ]
}
...
def register_user():
    ...
    print(f"New user registered: {email}") # For server log
...
def login_user():
    ...
    if stored_hashed_password and check_password_hash(stored_hashed_password, password):
        if email in SUBMITTED_QUIZZES:
            ...
            }), 200 # Status 200 as it's a valid login but business rule prevents further action
...
def get_quiz():
    # Send only questions and options, not the answers
    questions_for_frontend = []
    for q_idx, q in enumerate(quiz_content["questions"]):
...
def submit_quiz():
    ...
    user_answers = data.get('answers', []) # Default to empty list if not provided

    if not user_email:
        return jsonify({"success": False, "message": "User email not provided with submission."}), 400
    if user_email not in USER_ACCOUNTS: # Check if user is registered
    ...
    feedback_text = ""
    if percentage == 100:
        feedback_text = f"Perfect score, {feedback_name}! You're a market research whiz!"
    elif percentage >= 80:
        feedback_text = f"Excellent work, {feedback_name}! You have a strong understanding."
    elif percentage >= 60:
        feedback_text = f"Good job, {feedback_name}! You're getting the hang of it."
    elif percentage >= 40:
        feedback_text = f"Not bad, {feedback_name}. A little more study and you'll ace it!"
    else:
